...
public static void main (String [] args){
                ...
                switch(level){
                        ...
                        do {
                                ...
                                do{
                                        ...
                                        Commande co=Commande.create(ligne);
                                ...
                                while (iterator.hasNext()) {
                                        ...
                                        switch ( nomInstruction ) {
                                                ...
                                                case "ADDI":
                                                        ...
                                                        break;
                                                case "MULTI" : 
                                                        MULTI(instruction.getArguments().get(0),instruction.getArguments().get(1), register.getRegister(instruction.getArguments().get(2)),register);
                                                        break;
                                                case "SUBI" : 
    ...
    public static void MULTI(String A, String B, register C, PrimarRegister Register){
        int valA,valB;
        if(Register.contains(A)){
            valA=Register.getRegister(A).getValue();
        }
